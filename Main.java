...
public class Main {
  ...
  public static void MenuThemSPVaoBill(Bill bill) {
    while(true) {
      ConsoleProgram.clearConsole();
      ConsoleProgram.printTable(ProductManagement.Instance().GetList(), "SAN PHAM", ENV.columnTableProduct);
  ...
  public static void MenuLocSanPhamTheoTen(Bill bill, String nameProduct) {
    while(true) {
      ...
      ConsoleProgram.printTable(productList, "SAN PHAM", ENV.columnTableProduct);
  ...
  public static void MenuQuanLyHoaDon() {
    while (true) {
      ...
      switch (line) {
        case "1":
          ConsoleProgram.clearConsole();
          ConsoleProgram.printTable(BillManagement.Instance().GetList(), "HOA DON", ENV.columnTableBill);
  ...
  public static void MenuQuanLyNhanSu() {
    while (true) {
      ...
      switch (line) {
        case "1":
          ConsoleProgram.clearConsole();
          ConsoleProgram.printTable(PersonManagement.Instance().GetList(), "NHAN SU", ENV.columnTablePerson);
  ...
  public static void MenuTimKiemNhanSu() {
    while (true) {
      ...
      while (true) {
        ...
        ConsoleProgram.printTable(personList, "NHAN SU", ENV.columnTablePerson);
